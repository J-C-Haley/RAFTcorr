...
# Strain calculation moved to raft_dic_gui.strain — re-export for backward compatibility
from raft_dic_gui.strain import calculate_strain_field, _compute_rotation_field_numba  # noqa: F401
